...
CPU_Renderer::CPU_Renderer(const int32_t width, const int32_t height)
...
void CPU_Renderer::DrawTriangle(const Math::Mat4 &model,
...
void CPU_Renderer::DrawLine(const Math::Vec2 &point_1,
                            const Math::Vec2 &point_2,
...
void CPU_Renderer::DrawLineWithoutClip(const Math::Vec2 &p1,
                                       const Math::Vec2 &p2,
                                       const Math::Color &color) {
